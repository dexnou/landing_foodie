...
// Actualizamos la lista para el Marquee (Carrusel infinito del inicio)
const sponsorsLogos = [
...
export default function Home() {
  ...
  return (
    <main className="bg-brand-dark min-h-screen text-white overflow-x-hidden font-sans selection:bg-brand-lime selection:text-brand-dark">
      ...
      {/* 4. SPONSORS (ESTRUCTURA MINIMALISTA + TEXTOS ORIGINALES) */}
      <section id="sponsors" className="py-24 px-6 border-y border-white/5 bg-[#111]">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto border-t border-white/5 pt-12">
            ...
            {/* EMPRENDEDOR */}
            <div className="flex flex-col items-center md:border-l md:border-white/5">
              <div className="flex items-center justify-center gap-2 mb-6">
